      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed left-0 top-0 bottom-16 h-auto w-[min(88vw,360px)] max-w-[360px] rounded-none sm:bottom-0 sm:h-dvh sm:w-full sm:max-w-[320px] md:max-w-md bg-slate-800 z-101 shadow-[50px_0_100px_rgba(2,6,23,0.4)] flex flex-col overflow-hidden"
          >
