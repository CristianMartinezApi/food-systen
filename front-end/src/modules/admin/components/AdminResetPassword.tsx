  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="inline-flex flex-1 items-center justify-center gap-1 rounded-lg border border-blue-200 bg-blue-50 px-4 py-2.5 text-xs font-semibold text-blue-700 transition-colors hover:bg-blue-100 sm:flex-none"
      >
        <Lock size={14} />
        Reset Senha
      </button>
